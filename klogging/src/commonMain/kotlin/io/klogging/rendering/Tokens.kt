 ...
 */
internal data class StringToken(
    val value: String,
) : RenderToken()
 ...
 */
internal data class TimestampToken(
    val width: Int = 0,
) : RenderToken()
 ...
 */
internal data class LoggerToken(
    val width: Int = 0,
) : RenderToken()
 ...
 */
internal data class ContextToken(
    val width: Int = 0,
) : RenderToken()
 ...
 */
internal data class LevelToken(
    val width: Int = 0,
) : RenderToken()
 ...
 * Render log message.
 */
internal data class MessageToken(
    val width: Int = 0,
) : RenderToken()
 ...
 */
internal data class StacktraceToken(
    val maxLines: Int = 0,
) : RenderToken()
